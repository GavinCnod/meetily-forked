...
pub use commands::{
    ...
    __cmd__builtin_ai_get_model_info, __cmd__builtin_ai_get_models_directory,
    __cmd__builtin_ai_get_recommended_model, __cmd__builtin_ai_is_model_ready,
    __cmd__builtin_ai_list_models, builtin_ai_cancel_download, builtin_ai_delete_model, builtin_ai_download_model,
    builtin_ai_get_available_summary_model, builtin_ai_get_model_info, builtin_ai_get_models_directory,
